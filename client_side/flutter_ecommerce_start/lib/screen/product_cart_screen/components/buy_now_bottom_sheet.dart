                  ...
                  child: Consumer<CartProvider>(
                    builder: (context, cartProvider, child) {
                      return Column(
                        ...
                        children: [
                          Text(
                              'Total Amount             : \$${context.cartProvider.getCartSubTotal()}', //CartSubTotal
                              style: TextStyle(
                                  fontSize: 16,
                          ...
                          Text(
                              ...
                              style: const TextStyle(
                                  ...
                                  color: Colors.black)),
                          Text(
                              'Grand Total            : \$${context.cartProvider.getGrandTotal()}', // GrandTotal
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.blue)),
                ...
                Consumer<CartProvider>(
                  builder: (context, cartProvider, child) {
                    return CompleteOrderButton(
                        labelText:
                            'Complete Order  \$${context.cartProvider.getGrandTotal()} ', //GrandTotal
                        onPressed: () {
